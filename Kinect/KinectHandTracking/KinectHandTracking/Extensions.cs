...
namespace KinectHandTracking
{
    public static class Extensions
    {
        ...
        public static void DrawHand(this Canvas canvas, Joint hand)
        {
            if (hand.TrackingState == TrackingState.NotTracked) return;

            hand = hand.ScaleTo(canvas.ActualWidth, canvas.ActualHeight);
            ...
            Canvas.SetLeft(ellipse, hand.Position.X - ellipse.Width / 2);
            Canvas.SetTop(ellipse, hand.Position.Y - ellipse.Height / 2);

            canvas.Children.Add(ellipse);
        }

        public static void DrawThumb(this Canvas canvas, Joint thumb)
        {
            if (thumb.TrackingState == TrackingState.NotTracked) return;

            thumb = thumb.ScaleTo(canvas.ActualWidth, canvas.ActualHeight);
            ...
            Canvas.SetLeft(ellipse, thumb.Position.X - ellipse.Width / 2);
            Canvas.SetTop(ellipse, thumb.Position.Y - ellipse.Height / 2);
